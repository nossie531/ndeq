    ...
    T: Time,
{
    ...
    fn make_slope(slope: &mut Vec<V>, values: &[V], net: &NdeqNet<V>) {
        slope.clear();
    ...
    /// Calculate step 0.
    fn step0(&mut self, net: &NdeqNet<V>) {
    ...
    /// Calculate step 1.
    fn step1(&mut self, net: &NdeqNet<V>, h: T) {
    ...
    /// Calculate step 2.
    fn step2(&mut self, net: &NdeqNet<V>, h: T) {
    ...
    /// Calculate step 3.
    fn step3(&mut self, net: &NdeqNet<V>, h: T) {
